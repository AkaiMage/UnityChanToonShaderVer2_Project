Shader "UnityChanToonShader/ACiiL/Toon_DoubleShadeWithFeather_ClippingCutout" {
	Properties {
		[Enum(OFF,0,FRONT,1,BACK,2)] _CullMode("Cull Mode", int) = 2  //OFF/FRONT/BACK	Properties {
		...
		_shadowCastMin_black ("shadow cast blackness min. def=0", Range(0.0,1.0)) = 0.0
		[MaterialToggle] _Set_SystemShadowsToBase ("Shadow affects Shading", Float ) = 1
		...
		[MaterialToggle] _Is_BlendAddToHiColor ("Is_BlendAddToHiColor", Float ) = 1
		...
		[MaterialToggle] _MatCap ("Use MatCap", Float ) = 0
		...
		_OutlineshadowCastMin_black ("outline shadow cast blackness min. def=0", Range(0.0,1.0)) = 0.0
